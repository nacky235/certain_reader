...
public final class STPickerViewController: UIViewController {
    ...
    init(completion: @escaping ((BigGenre,Genre)) -> Void) {
...
extension STPickerViewController: UIPickerViewDataSource {
...
extension STPickerViewController: UIPickerViewDelegate {
